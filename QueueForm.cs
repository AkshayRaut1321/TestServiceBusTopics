namespace TestServiceBusTopics
{
    ...
    public partial class QueueForm : Form
    {
        ...
        string serviceBusConnectionString = "Endpoint=sb://akshayraut.servicebus.windows.net/;SharedAccessKeyName=SendListen;SharedAccessKey=UeHuwvn1cJJKBLclcUCX7Z6/r21Upq+L1+ASbP/NOOE=;EntityPath=testqueue";
        string queueName = "TestQueue";

        string deadLetterServiceBusConnectionString = "Endpoint=sb://akshayraut.servicebus.windows.net/;SharedAccessKeyName=SendListen;SharedAccessKey=UeHuwvn1cJJKBLclcUCX7Z6/r21Upq+L1+ASbP/NOOE=;EntityPath=testqueue/$DeadLetterQueue";
